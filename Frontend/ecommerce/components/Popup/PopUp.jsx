...
function PopUp({ onClose, title, description, redirectTo }) {
  ...
  return (
    <div className="fixed left-0 top-0 z-50 flex h-full w-full items-center justify-center bg-black/50 p-4">
      <div className="relative grid w-full max-w-screen-sm gap-y-2.5 rounded-[20px] bg-[#14213D] p-10 text-center text-white">
        ...
        <div className="mt-0 h-0.5 w-full overflow-hidden rounded-full bg-primary/20">
          <div
