    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-6 mt-6">
        ...
        <div className="grid grid-cols-2 gap-12 mt-6">
          ...
          <TextInput isRequired={true} label="Modelo" placeholder={""} />
        </div>
        ...
        <div className="space-y-4">
          <p className="font-bold text-xl">
            <IsRequired isRequired={true}>{"Código universal"}</IsRequired>
          </p>
          ...
          <p className="text-lg text-[#696969]">
            Podrás encontrar el código en la caja o etiqueta, junto al código de
            barras.
          </p>
        ...
        <small className="text-sm text-gray-500 my-8">
          En caso que su producto no lo tenga, no llene este casillero y elija
