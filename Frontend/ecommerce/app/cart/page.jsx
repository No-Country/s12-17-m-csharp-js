  ...
  return (
    <div>
      ...
      <div className="container relative mx-auto px-4 py-8">
        ...
        <h3 className="mb-4 flex text-xl text-[#FEAF00]"><Link href={"/supermarket"}><img src='assets/arrow.svg' className='mr-4' ></img></Link>  Continuar Comprando</h3>
        <div className='flex'>
          ...
          <div className=" mt-20 min-h-[600px] w-[916px] rounded-[20px] bg-[#EAEAEA] shadow-md">
            ...
            {cart.map(item => (
              <div key={item.id} className="flex h-[160px] items-center border border-gray-300 p-2">
                ...
                <div className="flex w-1/6 justify-between">
                  <button onClick={() => handleRemoveOne(item.id)} className="mx-4 h-7 w-7 rounded border border-black bg-[#EAEAEA] px-2 text-black">-</button>
                  <p>{item.quantity}</p>
                  <button onClick={() => handleAddOne(item.id)} className="mx-4 h-7 w-7 rounded border border-black bg-[#EAEAEA] px-2 text-black">+</button>
                </div>
          ...
          <div className='ml-10 mt-60 h-[150px] w-[350px] bg-[#FEAF00]'>
            ...
            <button onClick={handleCheckout} className="mx-auto flex h-[46px] w-[90%] items-center justify-center bg-black text-white">Continuar con la Compra</button>
